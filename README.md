...
<p align="center" >
  <kbd>
    <img
      src="https://github.com/codeGV/react-native-fast-image/blob/main/docs/assets/scroll.gif?raw=true"
      title="Scroll Demo"
      float="left"
    >
  </kbd>
  <kbd>
    <img
      src="https://github.com/codeGV/react-native-fast-image/blob/main/docs/assets/priority.gif?raw=true"
      title="Priority Demo"
      float="left"
    >
  </kbd>
...
**Note: You must be using React Native 0.60.0 or higher to use the most recent version of `@codegv/react-native-fast-image`.**

```bash
yarn add @codegv/react-native-fast-image
cd ios && pod install
```
...
-   FastImage - MIT © [codeGV](https://github.com/codeGV)
-   SDWebImage - `MIT`
...
[build]: https://github.com/codeGV/react-native-fast-image/actions?query=workflow%3ACI
...
[twitter]: https://twitter.com/home?status=Check%20out%20react-native-fast-image%20by%20%40atomarranger%20https%3A//github.com/codeGV/react-native-fast-image
[twitter-badge]: https://img.shields.io/twitter/url/https/github.com/codeGV/react-native-fast-image.svg?style=social
